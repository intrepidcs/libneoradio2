...
#define SWIGTYPE_p__CommandStateType swig_types[1]
#define SWIGTYPE_p__CommandStatus swig_types[2]
#define SWIGTYPE_p__Neoradio2DeviceInfo swig_types[3]
#define SWIGTYPE_p__StatusType swig_types[4]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(neoradio2)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(neoradio2)
ZEND_DECLARE_MODULE_GLOBALS(neoradio2)
#define SWIG_ErrorMsg() (neoradio2_globals.error_msg)
#define SWIG_ErrorCode() (neoradio2_globals.error_code)
#ifdef __GNUC__
...
static void neoradio2_init_globals(zend_neoradio2_globals *globals ) {
...
ZEND_NAMED_FUNCTION(_wrap_swig_neoradio2_alter_newobject) {
  zval args[2];
  swig_object_wrapper *value;
...
ZEND_NAMED_FUNCTION(_wrap_swig_neoradio2_get_newobject) {
  zval args[1];
  swig_object_wrapper *value;
...
static int le_swig__p__CommandStatus=0; /* handle for _p__CommandStatus */
static int le_swig__p__CommandStateType=0; /* handle for _p__CommandStateType */
static int le_swig__p_char=0; /* handle for _p_char */
static int le_swig__p__Neoradio2DeviceInfo=0; /* handle for Neoradio2DeviceInfo */
static int le_swig__p_uint8_t=0; /* handle for _p_uint8_t */
static int le_swig__p__StatusType=0; /* handle for _p__StatusType */
...
ZEND_NAMED_FUNCTION(_wrap_Neoradio2DeviceInfo_name_set) {
  ...
  if (SWIG_ConvertPtr(&args[0], (void **) &arg1, SWIGTYPE_p__Neoradio2DeviceInfo, 0) < 0) {
    SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Neoradio2DeviceInfo_name_set. Expected SWIGTYPE_p__Neoradio2DeviceInfo");
  }
...
ZEND_NAMED_FUNCTION(_wrap_Neoradio2DeviceInfo_name_get) {
  ...
  if (SWIG_ConvertPtr(&args[0], (void **) &arg1, SWIGTYPE_p__Neoradio2DeviceInfo, 0) < 0) {
    SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Neoradio2DeviceInfo_name_get. Expected SWIGTYPE_p__Neoradio2DeviceInfo");
  }
...
ZEND_NAMED_FUNCTION(_wrap_Neoradio2DeviceInfo_serial_str_set) {
  ...
  if (SWIG_ConvertPtr(&args[0], (void **) &arg1, SWIGTYPE_p__Neoradio2DeviceInfo, 0) < 0) {
    SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Neoradio2DeviceInfo_serial_str_set. Expected SWIGTYPE_p__Neoradio2DeviceInfo");
  }
...
ZEND_NAMED_FUNCTION(_wrap_Neoradio2DeviceInfo_serial_str_get) {
  ...
  if (SWIG_ConvertPtr(&args[0], (void **) &arg1, SWIGTYPE_p__Neoradio2DeviceInfo, 0) < 0) {
    SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Neoradio2DeviceInfo_serial_str_get. Expected SWIGTYPE_p__Neoradio2DeviceInfo");
  }
...
ZEND_NAMED_FUNCTION(_wrap_Neoradio2DeviceInfo_vendor_id_set) {
  ...
  if (SWIG_ConvertPtr(&args[0], (void **) &arg1, SWIGTYPE_p__Neoradio2DeviceInfo, 0) < 0) {
    SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Neoradio2DeviceInfo_vendor_id_set. Expected SWIGTYPE_p__Neoradio2DeviceInfo");
  }
...
ZEND_NAMED_FUNCTION(_wrap_Neoradio2DeviceInfo_vendor_id_get) {
  ...
  if (SWIG_ConvertPtr(&args[0], (void **) &arg1, SWIGTYPE_p__Neoradio2DeviceInfo, 0) < 0) {
    SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Neoradio2DeviceInfo_vendor_id_get. Expected SWIGTYPE_p__Neoradio2DeviceInfo");
  }
...
ZEND_NAMED_FUNCTION(_wrap_Neoradio2DeviceInfo_product_id_set) {
  ...
  if (SWIG_ConvertPtr(&args[0], (void **) &arg1, SWIGTYPE_p__Neoradio2DeviceInfo, 0) < 0) {
    SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Neoradio2DeviceInfo_product_id_set. Expected SWIGTYPE_p__Neoradio2DeviceInfo");
  }
...
ZEND_NAMED_FUNCTION(_wrap_Neoradio2DeviceInfo_product_id_get) {
  ...
  if (SWIG_ConvertPtr(&args[0], (void **) &arg1, SWIGTYPE_p__Neoradio2DeviceInfo, 0) < 0) {
    SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Neoradio2DeviceInfo_product_id_get. Expected SWIGTYPE_p__Neoradio2DeviceInfo");
  }
...
ZEND_NAMED_FUNCTION(_wrap_Neoradio2DeviceInfo__reserved_set) {
  ...
  if (SWIG_ConvertPtr(&args[0], (void **) &arg1, SWIGTYPE_p__Neoradio2DeviceInfo, 0) < 0) {
    SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Neoradio2DeviceInfo__reserved_set. Expected SWIGTYPE_p__Neoradio2DeviceInfo");
  }
  
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  
  if (SWIG_ConvertPtr(&args[1], (void **) &arg2, SWIGTYPE_p_uint8_t, 0) < 0) {
    SWIG_PHP_Error(E_ERROR, "Type error in argument 2 of Neoradio2DeviceInfo__reserved_set. Expected SWIGTYPE_p_uint8_t");
  }
...
ZEND_NAMED_FUNCTION(_wrap_Neoradio2DeviceInfo__reserved_get) {
  ...
  if (SWIG_ConvertPtr(&args[0], (void **) &arg1, SWIGTYPE_p__Neoradio2DeviceInfo, 0) < 0) {
    SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Neoradio2DeviceInfo__reserved_get. Expected SWIGTYPE_p__Neoradio2DeviceInfo");
  }
...
ZEND_NAMED_FUNCTION(_wrap_new_Neoradio2DeviceInfo) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p__Neoradio2DeviceInfo, 1);
...
static void __wrap_delete_Neoradio2DeviceInfo(zend_resource *res, const char *type_name) {
  ...
  arg1 = (_Neoradio2DeviceInfo *)SWIG_ConvertResourceData(ptr, type_name, SWIGTYPE_p__Neoradio2DeviceInfo);
  if (! arg1) zend_error(E_ERROR, "_Neoradio2DeviceInfo resource already free'd");
  delete arg1;
thrown:
  return;
fail:
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p__Neoradio2DeviceInfo) {
  __wrap_delete_Neoradio2DeviceInfo(res, SWIGTYPE_p__Neoradio2DeviceInfo->name);
}
/* end wrapper section */
...
static zend_function_entry neoradio2_functions[] = {
 SWIG_ZEND_NAMED_FE(neoradio2deviceinfo_name_set,_wrap_Neoradio2DeviceInfo_name_set,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(neoradio2deviceinfo_name_get,_wrap_Neoradio2DeviceInfo_name_get,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(neoradio2deviceinfo_serial_str_set,_wrap_Neoradio2DeviceInfo_serial_str_set,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(neoradio2deviceinfo_serial_str_get,_wrap_Neoradio2DeviceInfo_serial_str_get,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(neoradio2deviceinfo_vendor_id_set,_wrap_Neoradio2DeviceInfo_vendor_id_set,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(neoradio2deviceinfo_vendor_id_get,_wrap_Neoradio2DeviceInfo_vendor_id_get,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(neoradio2deviceinfo_product_id_set,_wrap_Neoradio2DeviceInfo_product_id_set,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(neoradio2deviceinfo_product_id_get,_wrap_Neoradio2DeviceInfo_product_id_get,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(neoradio2deviceinfo__reserved_set,_wrap_Neoradio2DeviceInfo__reserved_set,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(neoradio2deviceinfo__reserved_get,_wrap_Neoradio2DeviceInfo__reserved_get,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(new_neoradio2deviceinfo,_wrap_new_Neoradio2DeviceInfo,swig_arginfo_)
 SWIG_ZEND_NAMED_FE(swig_neoradio2_alter_newobject,_wrap_swig_neoradio2_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_neoradio2_get_newobject,_wrap_swig_neoradio2_get_newobject,NULL)
 ZEND_FE_END
};

/* init section */
zend_module_entry neoradio2_module_entry = {
...
zend_module_entry* SWIG_module_entry = &neoradio2_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &neoradio2_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(neoradio2)
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(neoradio2, neoradio2_init_globals, NULL);
...
le_swig__p__CommandStatus=zend_register_list_destructors_ex(_swig_default_rsrc_destroy, NULL, SWIGTYPE_p__CommandStatus->name, module_number);
SWIG_TypeClientData(SWIGTYPE_p__CommandStatus,&le_swig__p__CommandStatus);
le_swig__p__CommandStateType=zend_register_list_destructors_ex(_swig_default_rsrc_destroy, NULL, SWIGTYPE_p__CommandStateType->name, module_number);
SWIG_TypeClientData(SWIGTYPE_p__CommandStateType,&le_swig__p__CommandStateType);
le_swig__p_char=zend_register_list_destructors_ex(_swig_default_rsrc_destroy, NULL, SWIGTYPE_p_char->name, module_number);
SWIG_TypeClientData(SWIGTYPE_p_char,&le_swig__p_char);
le_swig__p__Neoradio2DeviceInfo=zend_register_list_destructors_ex(_wrap_destroy_p__Neoradio2DeviceInfo, NULL, SWIGTYPE_p__Neoradio2DeviceInfo->name, module_number);
SWIG_TypeClientData(SWIGTYPE_p__Neoradio2DeviceInfo,&le_swig__p__Neoradio2DeviceInfo);
le_swig__p_uint8_t=zend_register_list_destructors_ex(_swig_default_rsrc_destroy, NULL, SWIGTYPE_p_uint8_t->name, module_number);
SWIG_TypeClientData(SWIGTYPE_p_uint8_t,&le_swig__p_uint8_t);
le_swig__p__StatusType=zend_register_list_destructors_ex(_swig_default_rsrc_destroy, NULL, SWIGTYPE_p__StatusType->name, module_number);
SWIG_TypeClientData(SWIGTYPE_p__StatusType,&le_swig__p__StatusType);
CG(active_class_entry) = NULL;
/* end oinit subsection */

/* cinit subsection */
SWIG_LONG_CONSTANT(StatusInProgress, (int)StatusInProgress);
SWIG_LONG_CONSTANT(StatusFinished, (int)StatusFinished);
SWIG_LONG_CONSTANT(StatusError, (int)StatusError);
SWIG_LONG_CONSTANT(CommandStateHost, (int)CommandStateHost);
SWIG_LONG_CONSTANT(CommandStateDevice, (int)CommandStateDevice);
SWIG_LONG_CONSTANT(CommandStateUnknown, (int)CommandStateUnknown);
SWIG_LONG_CONSTANT(NEORADIO2_SUCCESS, (int)0);
SWIG_LONG_CONSTANT(NEORADIO2_FAILURE, (int)1);
SWIG_LONG_CONSTANT(NEORADIO2_ERR_WBLOCK, (int)2);
SWIG_LONG_CONSTANT(NEORADIO2_ERR_INPROGRESS, (int)3);
SWIG_LONG_CONSTANT(NEORADIO2_ERR_FAILURE, (int)4);
SWIG_LONG_CONSTANT(NEORADIO2_MAX_DEVS, (int)8);
SWIG_LONG_CONSTANT(StatusChain, (int)StatusChain);
SWIG_LONG_CONSTANT(StatusAppStart, (int)StatusAppStart);
SWIG_LONG_CONSTANT(StatusPCBSN, (int)StatusPCBSN);
SWIG_LONG_CONSTANT(StatusSensorRead, (int)StatusSensorRead);
SWIG_LONG_CONSTANT(StatusSensorWrite, (int)StatusSensorWrite);
SWIG_LONG_CONSTANT(StatusSettingsRead, (int)StatusSettingsRead);
SWIG_LONG_CONSTANT(StatusSettingsWrite, (int)StatusSettingsWrite);
SWIG_LONG_CONSTANT(StatusCalibration, (int)StatusCalibration);
SWIG_LONG_CONSTANT(StatusCalibrationPoints, (int)StatusCalibrationPoints);
SWIG_LONG_CONSTANT(StatusCalibrationStored, (int)StatusCalibrationStored);
SWIG_LONG_CONSTANT(StatusCalibrationInfo, (int)StatusCalibrationInfo);
SWIG_LONG_CONSTANT(StatusLedToggle, (int)StatusLedToggle);
SWIG_LONG_CONSTANT(StatusMax, (int)StatusMax);
